...
export let playerUseCloak = [
  ...
  `You wear the cloak like a ballerina in a tutu.  As you squeeze in, you notice that you cannot be seen by your enemies.  Isn't that conveeenient!`,
  `Your midsection nearly busts the seams out of the damn cloak, but once it is on, you are like an invisible sausage that cannot be sliced.`,
];
export let playerUsingGauntlet = [
  ...
  `You clumsily don the glove like a pig wears a watch.  Despite your ineptitude, you are stronger than you were before putting it on.`,
  `Once the glove is on, you feel your veins pulsing, your muscles growing, your eyes and skin turning green.  Mr. McGee, dont make me angry.  You wouldn't like me when I'm angry.`,
];
export let playerUsingTincutre = [
  ...
  `As you imbibe the fluid, you feel like there are lighting bolts shooting from every orifice on your body.  But this isn't really happening, its just your ego.  What's really happening is that your health is increased for a while.`,
];
export let playerUsingRing = [
  `The ring slides easily onto your hand and you are surrounded by a strange but comforting protective aura.`,
  `You slide into the ring like a Sunday morning slides in after a big Saturday night.  Despite the troubles, a protective glow surrounds you.`,
  `You wear the ring and are surrounded by a protective field.  Precious!  Precious!  My Precious!`,
];
export let playerUsingCrown = [
  ...
  `Like a greek god or a paratrooper, your attacks are twice as fast now, allowing two times the damage.`,
  `You don the tiara like a super model.  Lipstick cherry all over the lens as you're falling.  Your attacks now inflict damage x 2 while it lasts.`,
];
...
export let gauntletFade = [
  ...
  `The gauntlet power fades.  Life is a bitch, then you die, and people you never knew wear your clothes to places you've never been.`,
];
export let tinctureFade = [
  `You look around for a place to nap and recharge as your magic health dissipates.`,
  `As if you lost your insurance coverage, your health is no longer as assured as it was just a turn ago.`,
...
export let crownFade = [
  ...
  `Your double speed just slowed to real time.  Kinda like losing your broadband to dialup.`,
...
export let botUsingGauntlet = [
  `The enemy donned the Gauntlet of Strength.  You can hear the sound of your pulse in your ears as you realize that their strikes will cost more.`,
];
...
export let botUsingCrown = [
  `The enemy messed up their do while donning the Crown of Speed.  But they still do double damage, even with f'd a up hairdo.`,
];
...
export let crownInView = [
  ...
  `You are captured by the aura of a jeweled crown hanging from a low branch of a golden bough.`,
];
export let axeInView = [
  ...
  `There is a big axe here, which seems to be as hefty and balanced as anything you've ever lifted.`,
];
export let swordInView = [
  ...
  `You see a sword.  Too many have died at its edge.  It may look pure, but only becasue blood washes so easily from its blade.`,
];
...
export let botFallsEdge = [
  ...
  `Out of the corner of your eye, you notice your enemy waving their arms as they disappears over the edge.`,
...
export let playerDirectHits = [
  ...
  `You feel and hear a satisfying thud as the blade of your weapon makes full and meaningful contact.`,
  `The enemy sees that you mean buiness as the direct hit knocks them straight on their arse.`,
];
...
export let edgeNorth = [
  ...
  `Something in your nether regions begins to tighten up as you approach the Northern edge of the cliff.`,
...
export let edgeSouth = [
  ...
  `Something in your nether regions begins to tighten up as you approach the Southern edge of the cliff.`,
  `You feel a natural apprehension as you approach the Southern edge of the mesa.`,
];
export let edgeEast = [
  `Your head feels light and your vision grows dim near the Eastern cliff-edge of the grove.`,
  `Something in your nether regions begins to tighten up as you approach the Eastern edge of the cliff.`,
  `You feel a natural apprehension as you approach the Eastern edge of the mesa.`,
];
export let edgeWest = [
  `Your knees tremble as you peer over the Western ledge at the gorgeous vista of Lake Nemi.`,
  `Something in your nether regions begins to tighten up as you approach the Western edge of the cliff.`,
